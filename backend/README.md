...
## Project Structure
    ...
    ├── testaccountapp_dev_23593  # Django project configurations
...
1. Clone this repo and `cd testaccountapp_dev_23593`
...
2. Clone this repo and `cd testaccountapp_dev_23593`
